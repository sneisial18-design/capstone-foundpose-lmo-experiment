...
# Manually remove VSD for macOS local evaluation.
# VSD requires renderer/OpenGL/EGL; MSSD/MSPD can be used as partial evaluation.
p["errors"] = [e for e in p["errors"] if e.get("type") != "vsd"]
print("Running BOP19 evaluation without VSD. Remaining errors:", [e.get("type") for e in p["errors"]])
